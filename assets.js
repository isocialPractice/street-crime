...
const PLAYER = {
    ...
    knockDown:   loadSvgFile('assets/Player_KnockDown.svg'),
...
// Each entry: { idle, walk?, punch?, kick?, punch2?, attack?, defeat? }
...
// Attack sprite resolution order: punch → kick → attack (generic fallback for enemies without
// named attack sprites). 'punch2' holds a second punch frame shown after the first is held.
// Characters without any attack sprite use a rotation effect in draw() instead.
const ENEMY_CHARS = {
    // ── Full animation sets ───────────────────────────────────────────────────
    CrimeGuy:           { idle:    loadSvgFile('assets/CrimeGuy.svg'),
                          walk:    loadSvgFile('assets/CrimeGuy_walk.svg'),
    ...
    BadGirl:            { idle:    loadSvgFile('assets/BadGirl.svg'),
                          walk:    loadSvgFile('assets/BadGirl_walk.svg'),
    ...
    SassyGirl:          { idle:    loadSvgFile('assets/SassyGirl.svg'),
                          walk:    loadSvgFile('assets/SassyGirl_walk.svg'),
    ...
    JammingJabber:      { idle:    loadSvgFile('assets/JammingJabber.svg'),
                          walk:    loadSvgFile('assets/JammingJabber_walk.svg'),
    ...
    JumpingJunkie:      { idle:    loadSvgFile('assets/JumpingJunkie.svg'),
                          walk:    loadSvgFile('assets/JumpingJunkie_walk.svg'),
